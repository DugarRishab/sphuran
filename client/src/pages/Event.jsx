...
const Event = ({user, login, logout}) => {
	const events = [
		...
		// },
		{
			...
			rounds: "3",
			venue: <>Round 1- I hall <br></br> Round 2- EE seminar hall <br></br> Round 3- EE seminar hall</>,
			teamSize: "2 to 3",
			prizeMoney: "12,000",
			entryFee: "70/team",
...

		{
			...
			name: "Illumination ",
			img: "",
			desc: <p>Attention all electronics enthusiasts!   <br></br> Here's your chance to showcase your electronic skills! A series of challenging design problems awaits you at “Illumination”, a circuit simulation event. Your aim is to engineer the best electronic circuits that solve the problems, using any circuit simulation software of your choice. Credit will be given based on the functionality, ingenuity and efficiency of the design. We also have a hardware round, where you will be working with real components and breathing life into your designs.  <br></br> Have fun creating new circuits and watching the electrons dance around!</p>,
			rounds: "2",
